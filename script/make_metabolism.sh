...
perl -0777 -pi -E '@header = qw/ko:ID name definition l:label pathway:string_array pathway.name:string_array/; say(join("\t", @header))' $targetdir/out/nodes/newkonodes #prints the header
